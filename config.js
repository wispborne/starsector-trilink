/*
 * TriLink site settings.
 *
 * This is the one file you edit to configure the site. It loads before
 * everything else, so the values here are ready by the time the other scripts
 * run. No build step — just edit and save.
 */
